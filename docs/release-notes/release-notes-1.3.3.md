# Weight Tracker App - Release Notes v1.3.3
...
- ** Ajuste de configuraciones ** : Se pasa el icono de configuraciones dentro del perfil para mantener el balance estetico de las pestañas
